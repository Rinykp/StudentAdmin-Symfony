...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\CsvUploadType' => ['privates', 'App\\Form\\CsvUploadType', 'getCsvUploadTypeService', true],
            'App\\Form\\DivisionType' => ['privates', 'App\\Form\\DivisionType', 'getDivisionTypeService', true],
            'App\\Form\\MarksType' => ['privates', 'App\\Form\\MarksType', 'getMarksTypeService', true],
            'App\\Form\\ParentsType' => ['privates', 'App\\Form\\ParentsType', 'getParentsTypeService', true],
            'App\\Form\\RegistrationFormType' => ['privates', 'App\\Form\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Form\\SchoolClassType' => ['privates', 'App\\Form\\SchoolClassType', 'getSchoolClassTypeService', true],
            'App\\Form\\StudentType' => ['privates', 'App\\Form\\StudentType', 'getStudentTypeService', true],
            'App\\Form\\SubjectType' => ['privates', 'App\\Form\\SubjectType', 'getSubjectTypeService', true],
            'App\\Form\\TeacherType' => ['privates', 'App\\Form\\TeacherType', 'getTeacherTypeService', true],
            'App\\Form\\TimeTableType' => ['privates', 'App\\Form\\TimeTableType', 'getTimeTableTypeService', true],
            ...
            'App\\Form\\CsvUploadType' => '?',
            'App\\Form\\DivisionType' => '?',
            'App\\Form\\MarksType' => '?',
            'App\\Form\\ParentsType' => '?',
            'App\\Form\\RegistrationFormType' => '?',
            'App\\Form\\SchoolClassType' => '?',
            'App\\Form\\StudentType' => '?',
            'App\\Form\\SubjectType' => '?',
            'App\\Form\\TeacherType' => '?',
            'App\\Form\\TimeTableType' => '?',
